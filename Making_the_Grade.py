...
def letter_grades(highest):
    ...
    score_range_for_one_grade = int(score_range/4)
    scores = [40+score_range_for_one_grade*i+1 for i in range(4)]
    return scores
...
def student_ranking(student_scores, student_names):
    ...
    for index, student in enumerate(student_names):
        rating.append(f'{index+1}. {student}: {student_scores[index]}')
    return rating    
